...
class ResultsAnalyserWindow(QDialog):
    def __init__(self, parent=None):
        super(ResultsAnalyserWindow, self).__init__(parent)

        self.parentWindow = parent
        self.originalPalette = QApplication.palette()
        self.setWindowTitle("Results Analyser - " + __version__)
